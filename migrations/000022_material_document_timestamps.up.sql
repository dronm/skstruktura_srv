...
ALTER TABLE public.material_receipts
	...
	USING date::timestamp AT TIME ZONE public.register_business_timezone();
...
COMMENT ON COLUMN public.material_receipts.date IS 'Document date and time.';
COMMENT ON COLUMN public.material_consumptions.date IS 'Document date and time.';
COMMENT ON COLUMN public.material_transfers.date IS 'Document date and time.';
